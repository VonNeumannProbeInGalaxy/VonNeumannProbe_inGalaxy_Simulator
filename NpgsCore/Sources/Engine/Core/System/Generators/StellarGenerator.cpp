...
{                                                                                                                            \
	...
	{                                                                                                                        \
        Astro::FStellarClass::ESpectralClass::kSpectral_Unknown,                                                             \
        Astro::FStellarClass::ESpectralClass::kSpectral_Unknown,                                                             \
        Astro::FStellarClass::ELuminosityClass::kLuminosity_Unknown,                                                         \
        0, 0.0f, 0.0f, false                                                                                                 \
    };                                                                                                                       \
                                                                                                                             \
    Astro::AStar DeathStar;                                                                                                  \
    DeathStar.SetStellarClass(Astro::FStellarClass(Astro::FStellarClass::EStarType::kDeathStarPlaceholder, DeathStarClass)); \
...
std::vector<double> FStellarGenerator::GetFullMistData(const FBasicProperties& Properties, bool bIsWhiteDwarf, bool bIsSingleWhiteDwarf)
{
    ...
    if (!bIsWhiteDwarf)
    {
        ...
        PrefixDirectory.insert(0, Runtime::Asset::GetAssetFullPath(Runtime::Asset::EAssetType::kDataTable, "StellarParameters/MIST/[Fe_H]="));
    }
    else
    {
        if (bIsSingleWhiteDwarf)
        {
            PrefixDirectory = Runtime::Asset::GetAssetFullPath(Runtime::Asset::EAssetType::kDataTable, "StellarParameters/MIST/WhiteDwarfs/Thin");
        }
        else
        {
            PrefixDirectory = Runtime::Asset::GetAssetFullPath(Runtime::Asset::EAssetType::kDataTable, "StellarParameters/MIST/WhiteDwarfs/Thick");
        }
    }
...
void FStellarGenerator::CalculateSpectralType(float FeH, Astro::AStar& StarData)
{
    ...
    Astro::FStellarClass::EStarType StarType = StarData.GetStellarClass().GetStarType();
    ...
    if (EvolutionPhase != Astro::AStar::EEvolutionPhase::kWolfRayet)
    {
        switch (StarType)
        {
        case Astro::FStellarClass::EStarType::kNormalStar:
        {
            if (Teff < 54000)
            {
                CalculateSpectralSubclass(EvolutionPhase);
                ...
                if (EvolutionPhase != Astro::AStar::EEvolutionPhase::kWolfRayet)
                {
                    ...
                    {
                        if (SpectralType.HSpectralClass == Astro::FStellarClass::ESpectralClass::kSpectral_O && SurfaceH1 < MinSurfaceH1)
                        {
                            SpectralType.LuminosityClass = CalculateLuminosityClass(StarData);
                        }
                        else
        ...
        case Astro::FStellarClass::EStarType::kDeathStarPlaceholder:
        {
    ...
    Astro::FStellarClass Class(StarType, SpectralType);
...
Astro::FStellarClass::ELuminosityClass FStellarGenerator::CalculateLuminosityClass(const Astro::AStar& StarData)
{
    ...
    std::string HrDiagramDataFilePath = Runtime::Asset::GetAssetFullPath(Runtime::Asset::EAssetType::kDataTable, "StellarParameters/H-R Diagram/H-R Diagram.csv");
...
void FStellarGenerator::ProcessDeathStar(Astro::AStar& DeathStar, EGenerateOption Option)
{
    ...
    Astro::FStellarClass::EStarType     DeathStarType{};
    Astro::FStellarClass::FSpectralType DeathStarClass;
    ...
    if (InputFeH <= -2.0f && InputMassSol >= 140 && InputMassSol < 250)
    {
        ...
        DeathStarType  = Astro::FStellarClass::EStarType::kDeathStarPlaceholder;
        DeathStarClass =
        {
            Astro::FStellarClass::ESpectralClass::kSpectral_Unknown,
            Astro::FStellarClass::ESpectralClass::kSpectral_Unknown,
    ...
    else if (InputFeH <= -2.0f && InputMassSol >= 250)
    {
        ...
        DeathStarType  = Astro::FStellarClass::EStarType::kBlackHole;
        DeathStarClass =
        {
            Astro::FStellarClass::ESpectralClass::kSpectral_X,
            Astro::FStellarClass::ESpectralClass::kSpectral_Unknown,
            Astro::FStellarClass::ELuminosityClass::kLuminosity_Unknown,
            0, 0.0f, 0.0f, false
        };
    ...
    else
    {
        ...
        if (InputMassSol >= 0.075f && InputMassSol < 0.5f)
        {
            ...
            DeathStarType  = Astro::FStellarClass::EStarType::kWhiteDwarf;
            DeathStarClass =
            {
                Astro::FStellarClass::ESpectralClass::kSpectral_Unknown,
                Astro::FStellarClass::ESpectralClass::kSpectral_Unknown,
        ...
        else if (InputMassSol >= 9.759f && InputMassSol < 10.0f)
        {
            ...
            DeathStarType  = Astro::FStellarClass::EStarType::kNeutronStar;
            DeathStarClass =
            {
                Astro::FStellarClass::ESpectralClass::kSpectral_Q,
                Astro::FStellarClass::ESpectralClass::kSpectral_Unknown,
                Astro::FStellarClass::ELuminosityClass::kLuminosity_Unknown,
                0, 0.0f, 0.0f, false
            };
    ...
    if (Option == EGenerateOption::kMergeStar || DeathStarType == Astro::FStellarClass::EStarType::kNeutronStar)
    {
        ...
        else if (MassSol >= 1.5f && MassSol < 20.0f)
        {
                 ...
                 SpectralType.HSpectralClass == Astro::FStellarClass::ESpectralClass::kSpectral_B))
            {
                ...
                if (ProbabilityGenerator(_RandomEngine))
                {
                    ...
                    StarData.SetStellarClass(Astro::FStellarClass(Astro::FStellarClass::EStarType::kNormalStar, SpectralType));
                }
                else
                {
...
void FStellarGenerator::GenerateSpin(Astro::AStar& StarData)
{
    ...
    case Astro::FStellarClass::EStarType::kBlackHole: // 此处表示无量纲自旋参数，而非自转时间
    {
    ...
    if (StarType != Astro::FStellarClass::EStarType::kBlackHole)
    {
