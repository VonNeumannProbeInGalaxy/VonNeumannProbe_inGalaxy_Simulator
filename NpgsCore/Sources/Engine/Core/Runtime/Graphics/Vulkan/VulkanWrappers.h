...
// ----------------------------
//class FVulkanDeviceMemory
//{
//public:
//	FVulkanDeviceMemory();
//	FVulkanDeviceMemory(const vk::Device& Device, const vk::MemoryAllocateInfo& AllocateInfo);
//	FVulkanDeviceMemory(const FVulkanDeviceMemory&) = default;
//	FVulkanDeviceMemory(FVulkanDeviceMemory&& Other) noexcept;
//	~FVulkanDeviceMemory();
//
//	FVulkanDeviceMemory& operator=(const FVulkanDeviceMemory&) = default;
//	FVulkanDeviceMemory& operator=(FVulkanDeviceMemory&& Other) noexcept;
//
//	vk::DeviceMemory* operator->();
...
public:
    ...
    FVulkanFence(const vk::Device& Device, vk::FenceCreateFlags Flags = {});
...
public:
    ...
    FVulkanSemaphore(const vk::Device& Device, vk::SemaphoreCreateFlags Flags = {});
